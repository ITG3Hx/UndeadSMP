...
// einloggen, dafuer gibt es nichts, was jemand aus einer Datei klauen koennte.
...
/** Zeitkonstanter Vergleich, damit man das Passwort nicht ueber die Antwortzeit erraten kann. */
...
export function startWeb(client) {
  ...
  app.listen(port, () => console.log(`[web] Dashboard laeuft auf Port ${port}`));
  return app;
}
