...
const DEFAULTS = {
  tickets: {
    ...
    faqCategories: [
      ...
      { label: 'Bug melden', answer: 'Danke fürs Melden, das gilt auch für Kit-Probleme (z.B. Kit nicht komplett ausgerüstet). Beschreib möglichst genau, was passiert ist und wie man es nachstellen kann.' },
